...
![crane_game_101.png](./img/crane_game_101.png)
...
![crane_game_102.png](./img/crane_game_102.png)

만약 같은 모양의 인형 두 개가 바구니에 연속해서 쌓이게 되면 두 인형은 터뜨려지면서 바구니에서 사라지게 됩니다. 
위 상태에서 이어서 [5번] 위치에서 인형을 집어 바구니에 쌓으면 같은 모양 인형 **두 개**가 없어집니다.

![crane_game_103.gif](./img/crane_game_103.gif)
...
![crane_game_104.jpg](./img/crane_game_104.jpg)
